...
It has been awhile since I have posted a tutorial, or anything for that matter, on my website so I decided to revisit some data from my old post, <a href="http://www.austinwehrwein.com/academic-2/1700s-shipping-logs/">Shipping Data</a>.
...
First you will need the CLIWOC data I have messed with, <a href="http://www.austinwehrwein.com/wp-content/uploads/2015/12/CLIWOC15.csv">CLIWOC15</a>.

Then you will want the shapefile I used to create the minimalist plot which can be downloaded from <a href="http://www.naturalearthdata.com/downloads/10m-cultural-vectors/roads/">these blue letters</a>. The reason I wanted to use these shapefiles instead of leveraging the google street maps and other really easy R mapping tools is because of design preferences. Too many times have I seen what could have been a decent chance at a touch of character and design in data presentation fall by the wayside to ease and quick production. I really like the simple contrast and colors against the minimalist maps.
...
```{r multi,fig.path='../',dev='svg',include=F}
