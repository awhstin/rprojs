...
```{r batman, fig.height=7, fig.path='../', fig.width=12, message=FALSE, warning=FALSE, dev='svg',include=FALSE}
#prep and plot
...
```
```{r fig.height=7,fig.width=12, message=FALSE, warning=FALSE, dev='svg',out.height='75%',out.width='75%'}
#prep and plot
n.names<-grep("[[:digit:]]",V(graph)$name,value=T)  
