...
Directly below the table there is an 'Export to Excel' button. Which we can download and load directly into R using <code class="language-r">read.csv</code> which gets us some data to start with.
