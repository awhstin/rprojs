...
<a href="https://www.ams.usda.gov/local-food-directories/farmersmarkets/" target="_blank">U.S. Farmer's Markets.</a>

Directly below the table there is an 'Export to Excel' button. Which we can download and load directly into R using <code class="language-r">read.csv</code> which gets us something looking like this. (With many more columns)

<img src="http://www.austinwehrwein.com/wp-content/uploads/2014/04/Capture.png" alt="Capture" width="1024" height="464" class="aligncenter size-full wp-image-1816" />
